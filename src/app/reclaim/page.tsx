    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="flex-1 flex items-start justify-center px-4 py-12">
        <div className="w-full max-w-lg space-y-6">
          <div>
            <h1 className="text-2xl font-bold">Reclaim SOL</h1>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 px-4 py-3 rounded-xl bg-card border-2 border-border text-sm font-semibold hover:border-hop-500 transition-colors disabled:opacity-50"
              >
              ...
              <button
                ...
                className="flex-1 px-4 py-3 rounded-xl bg-hop-500 text-white text-sm font-semibold hover:bg-hop-600 transition-colors disabled:opacity-50"
              >
